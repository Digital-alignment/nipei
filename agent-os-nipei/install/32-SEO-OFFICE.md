...
3. **Open it** — in Nipei OS go to the **SEO** tab → **SEO Office**. When the badge shows **running**, the office loads right inside your dashboard.
...
- **Its own project** — SEO Office is maintained separately on GitHub (AGPL-3.0); Nipei OS just embeds it. Check its repo for what it can do + any keys it wants.
