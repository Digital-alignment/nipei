...
> 🛑 **Already built.** This sub-tab ships working inside the **SEO** tab — don't ask an AI to build it. If you don't see it, update your pack (`Update Nipei OS.command`).
...
4. For each platform it hands you a ready **play**: the format (thread / Reel / Short / video) and a **Claude-ready prompt**. Posts and threads route to the **Claude** tab; video formats route to the **Video Director** (Claude writes the script in-pipeline). You create everything inside your Nipei OS.
