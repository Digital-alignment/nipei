...
4. **Open it** — in Nipei OS go to the **SEO** tab → **OpenSEO**. When the badge shows **running**, you're set. (Behind the scenes it runs on `http://localhost:3001` and Nipei OS embeds it.)
