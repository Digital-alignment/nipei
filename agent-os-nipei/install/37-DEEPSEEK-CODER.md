...
> 🛑 **Already built.** This tab ships working in your Nipei OS — don't ask an AI to build it. If you don't see it, your pack is out of date: run `Update Nipei OS.command`.
...
2. **Give the key to Nipei OS** — add this line to `~/.fcc/.env` (or set it as an environment variable):
   ```
...
- **Costs are yours** — DeepSeek bills your key directly; nothing is charged by Nipei OS.
