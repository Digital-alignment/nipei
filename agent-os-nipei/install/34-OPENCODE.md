...
The **opencode** tab runs [opencode](https://opencode.ai) — a popular open-source coding agent (160k★) — right inside the Nipei OS. You type a prompt, it builds real files with a live tool loop on the right, and you download the result.
