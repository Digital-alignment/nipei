---
tags: [guide, nipei-os, notebooklm, sop]
---

# 📔 Add NotebookLM to Your Nipei OS
...
A new section in your Nipei OS called **Notebook**.
...
- 🎬 Watch videos and listen to audio right inside Nipei OS.
...
Open Claude Code in your Nipei OS folder.

Paste this prompt:

```
Add a new "Notebook" section to my Nipei OS.
...
2. Chat — ask questions about the active notebook using
   ...
   Nipei OS/Notebooks/<notebook>/chat-YYYY-MM-DD.md.
...
3. Studio — show 9 artifact-type pills (audio, video, slide_deck,
   ...
   and output_path. Save to Nipei OS/Notebooks/_assets/<notebook>/.
...
download all of them in parallel into Nipei OS/Notebooks/_assets/.
```
