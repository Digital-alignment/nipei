...
🟢 **Nipei OS already running on your laptop**
...
`seoPipeline.ts.template` is the config file Nipei OS reads.
...
## 🔧 Step 3: Tell Nipei OS where your sites are
...
Nipei OS will pick it up automatically.

---

## ⚡ Step 6: Connect Nipei OS to your setup

Open Nipei OS in your browser.

Click **SEO** in the sidebar.

You should now see your 5 sites listed.

If you don't, restart Nipei OS.
