...
- [ ] **Started the dashboard:**
  - **Mac:** double-click `Start Nipei OS.command` (first time: right-click → Open → Open).
...
- [ ] **Connected your Obsidian vault** — open any AI agent in the folder and say *"connect my Obsidian vault to the Nipei OS"* (`install/11-MEMORY-OBSIDIAN.md`). No vault = empty Memory Galaxy.
