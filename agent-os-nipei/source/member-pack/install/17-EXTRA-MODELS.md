...
> Power-user note: any tool that speaks OpenAI's chat-completion format (your own Python script, an Nipei OS dispatcher, a coding harness) just needs the base URL `https://api.sakana.ai/v1` and the Sakana key. No SDK migration.
