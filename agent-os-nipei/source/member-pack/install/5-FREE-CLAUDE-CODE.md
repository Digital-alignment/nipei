...
## Honest note
This is the most "techie" piece. If it doesn't click into place, don't worry — **everything else in the Nipei OS works fine without it**, and the voice-build from step 2 covers the main "build for free" use.
