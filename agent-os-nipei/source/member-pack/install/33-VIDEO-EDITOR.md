...
> 🛑 **This is already built into your dashboard — don't build it, and don't let your AI build it.** It's the **Video Editor** tab (left sidebar). If you don't see it, your pack is out of date — download the newest Nipei OS pack (check `build <date>` under the "Nipei OS" logo).
