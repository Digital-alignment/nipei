#!/usr/bin/env python3
"""Connect YOUR Google Search Console to the Nipei OS SEO → Research tab (read-only).
...
Files (all under ~/.nipei-os/, created for you):
...
def main():
    ...
    for d in sorted(latest):
        print(f"    • {d}")
    print("\nOpen Nipei OS → SEO → Research and pick a site. You're done.")
