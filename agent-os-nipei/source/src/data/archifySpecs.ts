...
export const PREBUILT_DIAGRAMS: PrebuiltDiagram[] = [
  ...
  {
    id: "nipei-ecosystem-v2-future",
    name: "Arquitectura Propuesta v2 (Multi-Cloud & Redis)",
    category: "Ecosistema & Infraestructura",
    type: "architecture",
    description: "Propuesta de arquitectura evolutiva con Cloudflare Edge, Redis Cache, Replica DB y Venu Voice Node.",
    spec: {
      schema_version: 1,
      diagram_type: "architecture",
      meta: {
        title: "Nipëi OS — Arquitectura v2 Multi-Cloud & High Availability",
        output: "nipei-v2-future.html",
        visual_preset: "signal-flow",
        quality_profile: "showcase",
      },
      components: [
        { id: "users", type: "external", label: "Usuarios", sublabel: "Browser / Mobile", pos: [40, 300], size: [120, 60] },
        { id: "auth", type: "security", label: "Auth Provider", sublabel: "OAuth 2.0 / Passkeys", pos: [40, 110], size: [130, 64], tag: "security" },
        { id: "cloudflare", type: "cloud", label: "Cloudflare Edge", sublabel: "WAF + Global CDN", pos: [250, 300], size: [130, 60] },
        { id: "lb", type: "cloud", label: "Reverse Proxy", sublabel: "HAProxy / Nginx", pos: [460, 300], size: [130, 60] },
        { id: "nipei_app", type: "backend", label: "Nipëi OS App", sublabel: "Next.js 15 Cluster", pos: [670, 300], size: [130, 60] },
        { id: "redis", type: "database", label: "Redis Cluster", sublabel: "L1 Cache & Queues", pos: [670, 150], size: [130, 60], tag: "cache" },
        { id: "hermes", type: "backend", label: "Hermes 2.0 RAG", sublabel: "Embeddings & Vectors", pos: [880, 150], size: [140, 60] },
        { id: "db_primary", type: "database", label: "Supabase Primary", sublabel: "PostgreSQL Master", pos: [880, 300], size: [130, 60] },
        { id: "db_replica", type: "database", label: "Supabase Replica", sublabel: "Read-only Vector Node", pos: [880, 440], size: [130, 60] },
        { id: "vault", type: "database", label: "nipei-vault", sublabel: "Obsidian Sync Engine", pos: [250, 440], size: [130, 60], tag: "knowledge" },
        { id: "agents", type: "backend", label: "Agentic Cluster", sublabel: "@antigravity @planner", pos: [670, 440], size: [130, 60] },
        { id: "venu", type: "backend", label: "Venu Voice Node", sublabel: "AI Telephony / Audio", pos: [460, 440], size: [130, 60] },
      ],
      boundaries: [
        { kind: "region", label: "Cloudflare Global Edge", wraps: ["cloudflare"] },
        { kind: "region", label: "Primary Hostinger & Supabase Cloud", wraps: ["lb", "nipei_app", "redis", "hermes", "db_primary", "db_replica", "vault", "agents", "venu"] },
      ],
      connections: [
        { id: "u-cf", from: "users", to: "cloudflare", label: "HTTPS / WAF", variant: "emphasis" },
        { id: "cf-lb", from: "cloudflare", to: "lb" },
        { id: "lb-app", from: "lb", to: "nipei_app" },
        { id: "app-redis", from: "nipei_app", to: "redis", label: "cache get/set" },
        { id: "app-hermes", from: "nipei_app", to: "hermes", label: "RAG query" },
        { id: "app-db", from: "nipei_app", to: "db_primary", label: "write" },
        { id: "app-replica", from: "nipei_app", to: "db_replica", label: "read-query", variant: "dashed", labelDy: 58 },
        { id: "app-agents", from: "nipei_app", to: "agents", label: "dispatch", labelDy: 58 },
        { id: "app-venu", from: "nipei_app", to: "venu", label: "WebRTC Audio", labelDy: 58 },
      ],
      cards: [
        { dot: "emerald", title: "Mejoras de la Versión v2", items: ["WAF y CDN Global con Cloudflare Edge", "Caché de consultas L1 con Redis", "Réplica de lectura en Supabase para alta disponibilidad", "Integración de voz nativa con Venu Voice Node"] },
      ],
    },
  },
  {
