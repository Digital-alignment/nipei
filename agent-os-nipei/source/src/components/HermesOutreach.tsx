...
// Midnight Aubergine palette (matches the Nipei OS design system).
const GOLD = "var(--gold)";
  ...
  return (
    <div className="grid lg:grid-cols-2 gap-4">
      ...
      <div className="panel p-4 space-y-3">
        ...
        <div className="text-[10.5px] text-[var(--fg-dimmer)]">Stored at ~/.nipei-os/outreach/config.json (chmod 600) — scoped to this tool, never shown in full.</div>
      </div>
      </div>
