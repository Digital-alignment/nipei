...
// with the Nipei OS: Claude writes it all — threads in the Claude tab, video
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-md border p-4" style={{ borderColor: "var(--line-soft)", background: "rgba(90,184,150,0.04)" }}>
        ...
        <div className="text-[11.5px] leading-relaxed" style={{ color: "var(--cream-dim)" }}>
          ...
          Below: your live search queries, auto-matched to the right play and the Nipei OS surface that makes it.
        </div>
      </div>
