      ...
      <div className="rounded-xl border p-4 mb-5" style={{ borderColor: "var(--panel-border)", background: "var(--panel)" }}>
        ...
        <p className="text-[10.5px] mt-3" style={{ color: "var(--fg-dimmer)" }}>
          Loops are token-hungry by design — so both the builder and the judge default to <b style={{ color: ACCENT }}>free</b> models (N2). {nous.loggedIn
            ...
            : <>Connect <b style={{ color: ACCENT }}>Nous Portal</b> — run <span className="font-mono">hermes portal</span> — for more free models in both dropdowns.</>} If the free judge ever throttles, it falls back to your <b style={{ color: ACCENT }}>local</b> model. Results save to your vault under <span className="font-mono">Nipei OS/Loops</span>.
        </p>
      </div>
