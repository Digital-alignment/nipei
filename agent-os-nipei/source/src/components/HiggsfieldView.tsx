  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="text-[11px] text-[var(--cream-mute)] px-1 flex items-center gap-1.5">
        <FolderOpen size={11} /> Saved to <span className="mono">~/.nipei-os/higgsfield/</span> — assets in <span className="mono">gallery/</span>, conversations in <span className="mono">sessions/</span>.
