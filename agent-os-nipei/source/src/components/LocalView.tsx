...
const HISTORY_KEY = "nipei-os/local/history/v1";
const ARTIFACTS_KEY = "nipei-os/local/artifacts/v1";
const ACTIVE_KEY = "nipei-os/local/active/v1";
const ENGINE_KEY = "nipei-os/local/engine/v1";
