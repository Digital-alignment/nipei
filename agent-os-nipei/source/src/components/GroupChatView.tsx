      ...
      <div className="flex-1 overflow-y-auto space-y-3 pr-1">
        {msgs.length === 0 && (
          <div className="text-center text-[13px] text-[var(--fg-dimmer)] leading-relaxed pt-10">
            ...
            <span className="text-[var(--fg-dim)]">&ldquo;What should I build next in my Nipei OS?&rdquo;</span> · <span className="text-[var(--fg-dim)]">&ldquo;@codex how would you structure this?&rdquo;</span>
          </div>
        )}
