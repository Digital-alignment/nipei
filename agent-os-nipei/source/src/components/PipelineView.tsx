...
export default function PipelineView() {
  ...
  if (!available) return (
    <div className="panel p-6 text-center text-[var(--fg-dim)]">
      Pipeline needs your Obsidian vault configured. Set <code>vaultRoot</code> in your Nipei OS config, then reload.
    </div>
  );
  ...
  return (
    <div className="relative">
      ...
      <p className="text-[12.5px] text-[var(--fg-dimmer)] mb-4">Drop an idea → agents classify it, route it, and draft a plan → you approve once → a PM + subagents build it. It all lives in your Obsidian vault under <span className="font-mono">Nipei OS/Pipeline/</span>.</p>
