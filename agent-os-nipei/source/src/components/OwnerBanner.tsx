...
// Promo banner for the pack owner's OWN Nipei OS only (their recordings / screenshots).
...
export default function OwnerBanner() {
  ...
  return (
    <a
      href="https://www.skool.com/ai-profit-lab-7462/about"
      target="_blank"
      rel="noopener"
    ...
    >
      ...
      <span>Get the <strong style={{ textDecoration: "underline", textUnderlineOffset: "3px" }}>Nipei OS</strong> + join <strong>4,000+ founders</strong> inside the AI Profit Boardroom</span>
      <span style={{
