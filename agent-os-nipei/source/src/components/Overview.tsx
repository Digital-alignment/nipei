    ...
    <div className="space-y-10">
      ...
      <section>
        <div className="eyebrow mb-5">
          ...
          <span className="line" />
          <span className="label">Nipëi OS · Módulos Core da Empresa (Duplo Núcleo)</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <SelfCard
            href="/flow"
            title="Nipëi Flow"
            tagline="Supply chain, automação de estoque, trazabilidade Aldeia Mutum, leitor QR & OCR."
            icon={<Brain size={20} />}
            accent="#22c55e"
            stat="Operações & Estoque Em Tempo Real"
          />
          <SelfCard
            href="/people"
            title="Nipëi People"
            tagline="CRM 360º, anamnese protegida pelo Firewall Espiritual, IA emocional & autoatendimento."
            icon={<Target size={20} />}
            accent="#4ade80"
            stat="Participantes · Compradores · Doadores"
          />
          <SelfCard
            href="/brain"
            title="Nipëi Brain"
            tagline="Governança global, Minhas Tarefas por Squad, DRE em tempo real & bot WhatsApp."
            icon={<BookOpen size={20} />}
            accent="#10b981"
            stat="Estratégia & DRE por Centro de Custo"
          />
        </div>
      </section>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
          <AgentPortal
            href="/antigravity"
            title="Antigravity"
            tagline="Primary agentic harness. Multi-agent workflows, workspace inspection, live tool execution."
            icon={<AgentAvatar agent="antigravity" size={28} />}
            accent="#22c55e"
            status="ok"
            metrics={[
              { label: "Mode", value: "NEXUS-Sprint" },
          ...
          <AgentPortal
            href="/hermes"
            title="Hermes (Local)"
            tagline="Local Nous Research agent. Tool calls, kanban, skills, plugins."
