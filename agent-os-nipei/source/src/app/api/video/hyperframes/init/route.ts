...
<body>
<div id="stage" data-composition-id="nipei-os-starter" data-start="0" data-width="1920" data-height="1080" data-duration="5" data-fps="30">
  <div class="title">
    <h1 id="t1">${prompt.replace(/</g, "&lt;").slice(0, 200)}</h1>
    <p id="t2">Made with Nipei OS · HyperFrames</p>
  </div>
</div>
...
<script>
  ...
  window.__timelines["nipei-os-starter"] = tl;
</script>
</body>
</html>
`;
...
const FX_JS = `// Nipei OS video FX library — deterministic GSAP helpers. Load AFTER gsap.
(function () {
