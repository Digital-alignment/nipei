...
// read-only token + their verified-site list under ~/.nipei-os/gsc-*.
const AOS = path.join(os.homedir(), ".nipei-os");
// gsc-research.py ships in the pack (scripts/); prefer the bundled copy, fall back to
// a user-installed one under ~/.nipei-os for older setups.
