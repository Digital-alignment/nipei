// Music history + storage for the /music tab in Nipei OS.
//
// Every generated track is downloaded into ~/.nipei-os/music/ as:
...
export const MUSIC_ROOT = path.join(HOME, ".nipei-os", "music");
