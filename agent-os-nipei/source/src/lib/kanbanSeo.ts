...
// identity, never a hardcoded one. Members set "userName" in ~/.nipei-os/config.json.
...
${out.join("\n")}
<div class="foot">Written by the Hermes content team in the Nipei OS Kanban · ready to deploy to ${esc(siteName)}</div>
</article></body></html>`;
}
